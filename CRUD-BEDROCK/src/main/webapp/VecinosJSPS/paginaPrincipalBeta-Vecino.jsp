        ...
        <div class="ParteSuperior" style="overflow-x: hidden">
            ...
            <nav class="letra_botones_encabezado">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a href="http://localhost:8080/Grupo2_war/VecinosJSPS/paginaEventos-Vecino.jsp" class="nav-link">Eventos</a>
                    </li>
                    <li class="nav-item">
                        <a href="<%=request.getContextPath()%>/VecinosJSPS/IncidenciaServlet?action=formCrear" class="nav-link">Reportar Incidencia</a>
                    </li>
                    <li class="nav-item">
                        <a href="<%=request.getContextPath()%>/VecinosJSPS/IncidenciaServlet?action=lista3&idUsuario=<%=usuarioSesion.getId()%>" class="nav-link">Lista de Incidencias</a>
                    </li>
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/VecinosJSPS/EventoServlet?action=calendario" class="nav-link">Mira Tu Calendario!</a>
                    </li>
                    <li class="nav-item">
