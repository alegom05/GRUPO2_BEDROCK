        ...
        <form class="row align-items-start needs-validation" novalidate>
                ...
                <div>
                    ...
                    <div class="input-group">
                        ...
                        <button class="btn btn-outline-secondary" type="button" onclick="enableField('urbanizacionInput')">
                            <img src="${pageContext.request.contextPath}/logos-Vecino/pencil.png" width="20" height="20">
                        </button>
                    </div>
                </div>
                <div>
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control" placeholder="*************" aria-describedby="button-addon2" disabled>
            ...
            <div class="col me-4">
                ...
                <div>
                    ...
                    <div class="input-group">
                        <input type="text" id="telefonoInput" class="form-control" placeholder="Falta Telefono" disabled oninput="validatePhoneInput(this)">
