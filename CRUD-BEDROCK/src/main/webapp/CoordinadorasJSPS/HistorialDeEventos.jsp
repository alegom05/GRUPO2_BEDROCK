	...
	<div class="mt-4" style="height: 100vh; margin: 0;">
		...
		<div class="tabla-container">
            <table id="miTabla" class="display">
                ...
                <tbody>
                    <tr>
                        <td>Maraton de San Miguel</td>
                        
                        <td>En curso</td>
                        <td>2024-04-19</td>
                        <td>
                            <a href="ModificarEvento.html">
                              <img src="./Iconos/modificar5.png" alt="Descripción de la imagen" class="mi-imagen">
                            </a>
                        </td>
                        
                        <td>
                            <a href="FinalizarEvento.html">
                              <img src="./Iconos/finalizar5.png" alt="Descripción de la imagen" class="mi-imagen">
                            </a>
                        </td>
                        <td>
                            
                            <img src="./Iconos/eliminar5.png" alt="Descripción de la imagen" class="mi-imagen" data-toggle="modal" data-target="#confirmModal">
                            
                        </td>

                    </tr>
                    <tr>
                        <td>Torneo de futbol juvenil</td>
...
<div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal" id="confirmCancelar">Cancelar</button>
          <!-- Aquí puedes colocar la acción que desees realizar al confirmar -->
  ...
  <script>
    ...
    document.getElementById('confirmCancelar').addEventListener('click', function() {
        window.location.href = 'HistorialDeEventos.html';
    });
