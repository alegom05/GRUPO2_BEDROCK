...
('Yoga-Julio', '2024-07-16', '2024-07-17', X'' , 'Colchonetas, balones', 'Parque Kennedy, San Miguel, Lima', '08:00:00', '1', '0', 'Yoga para adultos mayores, embarazadas y jóvenes', 'Cultural', '1', 'Pronto'),
('Fútbol-Julio', '2024-07-18', '2024-07-19', X'', 'Balones, redes', 'Complejo Deportivo San Miguel, Lima', '16:00:00', '2', '1', 'Competencia de fútbol', 'Deportivo', '4', 'Pronto'),
('Voley-Agosto', '2024-08-20', '2024-08-21', X'', 'Balones, redes', 'Parque de la Juventud, San Miguel, Lima', '10:00:00', '3', '12', 'Competencia de vóley', 'Deportivo', '5', 'Pronto'),
('Atletismo-Septiembre', '2024-09-04', '2024-09-05', X'', 'Cronómetros, banderines', 'Estadio Miguel Grau, San Miguel, Lima', '09:00:00', '4', '14', 'Competencia de atletismo', 'Deportivo', '4', 'Pronto'),
('Tres pies-Septiembre', '2024-09-06', '2024-09-07', X'', 'Cuerdas, pañuelos', 'Parque El Olivar, San Miguel, Lima', '15:00:00', '5', '11', 'Carrera de tres pies', 'Deportivo', '7', 'Pronto'),
('Familiar-Octubre', '2024-10-06', '2024-10-06', X'', 'Juegos de mesa, pelotas', 'Municipalidad de San Miguel, Lima', '10:30:00', '1', '20', 'Festival de juegos familiares', 'Cultural', '8', 'Pronto'),
('Niños-Noviembre', '2024-11-07', '2024-11-08', X'', 'Pelotas, conos', 'Parque Urubamba, San Miguel, Lima', '14:00:00', '2', '15', 'Juegos deportivos para los niños', 'Deportivo', '9', 'Pronto'),
('Tres pies-Julio', '2024-07-15', '2024-07-16', X'', 'Cuerdas, pañuelos', 'Parque Helio, San Miguel, Lima', '16:00:00', '2', '18', 'Yoga para adultos mayores, embarazadas y jóvenes', 'Deportivo', '7', 'En curso'),
('Familiar-Julio', '2024-07-15', '2024-07-16', X'', 'Juegos de mesa, pelotas', 'Parque Los Rosales, San Miguel, Lima', '10:30:00', '3', '12', 'Competencia de fútbol', 'Cultural', '8', 'En curso'),
('Niños-Julio', '2024-07-15', '2024-07-16', X'', 'Pelotas, conos', 'Parque Kennedy, San Miguel, Lima', '14:00:00', '4', '14', 'Competencia de vóley', 'Deportivo', '10', 'En curso'),
('Yoga-Junio', '2024-06-15', '2024-06-15', X'', 'Esterillas, pelotas', 'Estadio Miguel Grau, San Miguel, Lima', '17:00:00', '5', '16', 'Competencia de atletismo', 'Cultural', '3', 'Culminado'),
('Fútbol-Junio', '2024-06-16', '2024-06-16', X'', 'Balones, redes', 'Parque El Olivar, San Miguel, Lima', '11:30:00', '1', '19', 'Carrera de tres pies', 'Deportivo', '4', 'Culminado'),
('Voley-Junio', '2024-06-17', '2024-06-17', X'', 'Balones, redes', 'Municipalidad de San Miguel, Lima', '13:00:00', '2', '20', 'Festival de juegos familiares', 'Deportivo', '7', 'Culminado'),
('Atletismo-Junio', '2024-06-18', '2024-06-18', X'', 'Cronómetros, banderines', 'Complejo Deportivo San Miguel, Lima', '08:00:00', '3', '15', 'Juegos deportivos para los niños', 'Deportivo', '8', 'Culminado'),
('Tres pies-Junio', '2024-06-19', '2024-06-19', X'', 'Cuerdas, pañuelos', 'Parque de la Juventud, San Miguel, Lima', '16:00:00', '4', '18', 'Yoga para adultos mayores, embarazadas y jóvenes', 'Deportivo', '9', 'Culminado'),
('Familiar-Junio', '2024-06-20', '2024-06-20', X'', 'Juegos de mesa, pelotas', 'Estadio Miguel Grau, San Miguel, Lima', '10:30:00', '5', '12', 'Competencia de fútbol', 'Cultural', '10', 'Culminado'),
...
-- evento_has_usuario
INSERT INTO `basededatos3`.`evento_has_usuario` (`idEvento`, `idUsuario`, `asistio`, `cometioFalta`, `descripcion`) VALUES ('2018', '12', '1', '0',NULL);
...
INSERT INTO `basededatos3`.`evento_has_usuario` (`idEvento`, `idUsuario`, `asistio`, `cometioFalta`,`descripcion`) VALUES ('2017', '7', '1', '0',NULL);
INSERT INTO `basededatos3`.`evento_has_usuario` (`idEvento`, `idUsuario`, `asistio`, `cometioFalta`, `descripcion`) VALUES ('2018', '8', '1', '0',NULL);
INSERT INTO `basededatos3`.`evento_has_usuario` (`idEvento`, `idUsuario`, `asistio`, `cometioFalta`,`descripcion`) VALUES ('2012', '10', '0', '0',NULL);
INSERT INTO `basededatos3`.`evento_has_usuario` (`idEvento`, `idUsuario`, `asistio`, `cometioFalta`,`descripcion`) VALUES ('2016', '12', '1', '0',NULL);
INSERT INTO `basededatos3`.`evento_has_usuario` (`idEvento`, `idUsuario`, `asistio`, `cometioFalta`,`descripcion`) VALUES ('2017', '2', '1', '0',NULL);
INSERT INTO `basededatos3`.`evento_has_usuario` (`idEvento`, `idUsuario`, `asistio`, `cometioFalta`,`descripcion`) VALUES ('2018', '11', '1', '0',NULL);
INSERT INTO `basededatos3`.`evento_has_usuario` (`idEvento`, `idUsuario`, `asistio`, `cometioFalta`,`descripcion`) VALUES ('2019', '2', '1', '0',NULL);
INSERT INTO `basededatos3`.`evento_has_usuario` (`idEvento`, `idUsuario`, `asistio`, `cometioFalta`,`descripcion`) VALUES ('2020', '15', '1', '0',NULL);
INSERT INTO `basededatos3`.`evento_has_usuario` (`idEvento`, `idUsuario`, `asistio`, `cometioFalta`,`descripcion`) VALUES ('2004', '11', '0', '0',NULL);
INSERT INTO `basededatos3`.`evento_has_usuario` (`idEvento`, `idUsuario`, `asistio`, `cometioFalta`,`descripcion`) VALUES ('2020', '3', '1', '0',NULL);
INSERT INTO `basededatos3`.`evento_has_usuario` (`idEvento`, `idUsuario`,  `asistio`, `cometioFalta`, `descripcion`) VALUES ('2019', '5', '1', '0',NULL);
INSERT INTO `basededatos3`.`evento_has_usuario` (`idEvento`, `idUsuario`, `asistio`, `cometioFalta`,`descripcion`) VALUES ('2018', '13', '1', '1','Fomenta a la destruccion de la propiedad publica y genera altercados');
